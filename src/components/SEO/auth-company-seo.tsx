...
export const AuthCompanySEO = ({ company, page }: CatalogSEOProps) => {
  ...
  return (
    <Head>
      ...
      {/* PWA */}
      <meta name="application-name" content="Catalogo" />
      <meta name="apple-mobile-web-app-capable" content="yes" />
      <meta name="apple-mobile-web-app-status-bar-style" content="default" />
      <meta name="apple-mobile-web-app-title" content="Catalogo" />
      <meta name="description" content="Best Catalogo in the world" />
